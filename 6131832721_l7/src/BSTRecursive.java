...
public class BSTRecursive {
	...
	public int numNodesLessThan(BSTNode n,int v) {
		if(n==null) 
			return 0;
		int countLeft = numNodesLessThan(n.left,v);
		int countRight = numNodesLessThan(n.right,v);
		return (n.data<v?1:0)+countLeft+countRight;		
	}
	...
	public int numLeavesLessThan(BSTNode n, int v) {
		...
		if(n.left==null && n.right==null && n.data<v) 
			return 1;		
		int countLeft = numLeavesLessThan(n.left,v);
		int countRight = numLeavesLessThan(n.right,v);
	...
	public int nextOf(BSTNode n,int v) {
		if(((TreeIterator)findMax()).currentNode.data<=v)
			return v;
		if(n.data<=v && n.right!=null) {
			return nextOf(n.right,v);
		}
		if(n.left!=null) {
			if(((TreeIterator)findMax(n.left)).currentNode.data>v &&
				findMax(n.left)!=null) {
